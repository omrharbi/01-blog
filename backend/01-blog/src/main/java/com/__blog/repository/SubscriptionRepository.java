...
public interface SubscriptionRepository extends JpaRepository<Subscription, UUID> {
    ...
    Page<Subscription> findBySubscriberUser_Id(UUID subscriberId, Pageable pageable);

    // Get all subscriptions where I am subscribed to (followers)
    Page<Subscription> findBySubscribedTo_Id(UUID subscribedToId, Pageable pageable);
